...
//#define kAPPWidth [UIScreen mainScreen].bounds.size.width-10
//#define kAppHeight [UIScreen mainScreen].bounds.size.height-44

//图片缩放比例
#define kMinZoomScale 0.4f
...
// 图片间的间距
#define kPhotoBrowserImageViewMargin 0
